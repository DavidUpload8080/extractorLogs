...
public class ListadoMX extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2391731943271954422L;
	/**
	 * 
	 */
	 ...
	 * @throws Exception 
	 */
	public ListadoMX() throws Exception {
		setTitle("Carga de Listado Reporte MX");
		...
		String nombre_archivo_f01c = Propiedades.showProperties("dir.archivo.listado.mx");
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
					String nombre_archivo_mx = Propiedades.showProperties("dir.archivo.listado.mx");
		...
		JLabel lblListadoInterfacesFc = new JLabel("Listado Interfaces MX");
